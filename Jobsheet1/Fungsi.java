public class Fungsi {
    ...
    public static void PendapatanTiapCabang(){
        ...
        System.out.println("=========================================================");
        System.out.println("PENDAPATAN TOKO BUNGA ROYAL GARDEN");
        System.out.println("=========================================================");
    ...
    public static void StockRoyalGarden4(){
        System.out.println("=========================================================");
        System.out.println("Stok Bunga Yang Tersedia Di Toko RoyalGarden4");
        System.out.println("=========================================================");
        for (int a = 0; a < 4; a++){
            System.out.println("Stok " + jenisBunga[a] + " : " + RoyalGarden[3][a]);
        }
        System.out.println("=========================================================");
        System.out.println("Ada Beberapa Bunga Yang Mati, Maka Stok Menjadi : ") ;
        for (int a = 0; a < 4; a++){
            if (a == 0) {
                RoyalGarden[3][a] -= 1;
            } else if (a == 1) {
