public class DataDosen12 {
    void dataSemuaDosen(Dosen12[] arrayOfDosen,int n){
        System.out.println("======================================");
    ...
    void jumlahDosenPerJenisKelamin(Dosen12[] arrayOfDosen, int n){
        System.out.println("======================================");
    ...
    void rerataUsiaDosenPerJenisKelamin(Dosen12[] arrayOfDosen, int n){
        System.out.println("======================================");
    ...
    void infoDosenPalingTua(Dosen12[] arrayOfDosen, int n) {
        System.out.println("======================================");
    ...
    void infoDosenPalingMuda(Dosen12[] arrayOfDosen, int n ) {
        System.out.println("======================================");
