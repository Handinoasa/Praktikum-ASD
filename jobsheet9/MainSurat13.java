...
public class MainSurat13 {
    public static void main(String[] args) {
        ...
        int menu;
        Surat12[] srtTerverif = new Surat12[10];
        int jmlVerif = 0;
        ...
        do {
            ...
            switch (menu) {
                case 1:
                    ...
                    input.nextLine();
                    Surat12 srt = new Surat12(idSurat, namaMahasiswa, kelas, jenisIzin, durasi);
                    stack.push(srt);
                    System.out.printf("Surat %s berhasil dikumpulkan\n", srt.namaMahasiswa);
                    break;

                case 2:
                    Surat12 dicek = stack.pop();
                    if (dicek != null) {
                        System.out.println();
                ...
                case 4:
                    ...
                    if (find) {
                        if (posisi >= 0 && posisi < stack.size && stack.stack[posisi] != null) {
                            Surat12 suratDitemukan = stack.stack[posisi];
                            System.out.println("\nSurat Ditemukan : ");
                            ...
                            Surat12 suratDitemukan = srtTerverif[posisi];
                            System.out.println("\nSurat Ditemukan : ");
                            System.out.println("ID Surat : " + suratDitemukan.idSurat);
                            System.out.println("Nama Mahasiswa : " + suratDitemukan.namaMahasiswa);
                            System.out.println("Kelas : " + suratDitemukan.kelas);
